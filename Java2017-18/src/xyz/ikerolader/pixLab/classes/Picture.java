...
public class Picture extends SimplePicture 
{
  ...
  public void greyscale()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        int tmp=(pixelObj.getRed()+pixelObj.getGreen()+pixelObj.getBlue())/3;
        pixelObj.setRed(tmp);
        pixelObj.setGreen(tmp);
        pixelObj.setBlue(tmp);
      }
    }
  }
